...
export async function runAgent(
  ...
  // Strip the CLAUDECODE env var so the subprocess doesn't refuse to launch
  // thinking it's nested inside another Claude Code session.
  sdkEnv.CLAUDECODE = undefined;
